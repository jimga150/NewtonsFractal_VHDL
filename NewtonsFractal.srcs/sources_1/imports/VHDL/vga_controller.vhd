...
entity vga_controller is
    ...
    port(
        ...
        o_v_sync_polarity   :   out std_logic;  --matches active state of v_sync
        o_h_pixels          :   out integer;
        o_v_pixels          :   out integer
    ); 
end vga_controller;
...
begin
    ...
    o_v_sync_polarity <= g_v_pol;
    o_h_pixels <= g_h_pixels;
    o_v_pixels <= g_v_pixels;
